...
public class MimeTypeMap 
{
    ...
    private class MimeTypeItem
    {
        
        public MimeTypeItem(String mimetype,int icon)
        {
            mMimetype = mimetype;
            mIcon = icon;
        }
    ...
    private MimeTypeMap() 
    {
        mExtensionToMimeTypeMap = new HashMap<String, MimeTypeItem>();
    }
     ...
     */
    private void loadEntry(String mimeType,String extension,int icon) 
    {
        MimeTypeItem item = new MimeTypeItem(mimeType,icon);
        mExtensionToMimeTypeMap.put(extension, item);
    }
    private void loadEntry(String mimeType,String extension) 
    {
        MimeTypeItem item = new MimeTypeItem(mimeType,R.drawable.common_file);
        mExtensionToMimeTypeMap.put(extension, item);
    }
    public String getMimeTypeFromExtension(String extension) 
    {
        ...
        {
            MimeTypeItem item = mExtensionToMimeTypeMap.get(extension);
            if(item!=null)
    ...
    public int getDefaultIconFromExtension(String extension) 
    {
        if (extension != null && extension.length() > 0) 
        {
            MimeTypeItem item =  mExtensionToMimeTypeMap.get(extension);
    ...
    public static MimeTypeMap getSingleton() 
    {
        if (sMimeTypeMap == null) 
        {
            ...
            sMimeTypeMap.loadEntry("application/pdf", "pdf",R.drawable.pdf_file);
            ...
            sMimeTypeMap.loadEntry("application/x-shockwave-flash", "swf",R.drawable.swf_file);
            ...
            sMimeTypeMap.loadEntry("audio/3gpp", "3gpp",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/basic", "snd",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/midi", "mid",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/midi", "midi",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/midi", "kar",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/mpeg", "mpga",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/mpeg", "mpega",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/mpeg", "mp2",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/mpeg", "mp3",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/mpeg", "m4a",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/mpegurl", "m3u",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/prs.sid", "sid",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/x-aiff", "aif",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/x-aiff", "aiff",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/x-aiff", "aifc",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/x-gsm", "gsm",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/x-mpegurl", "m3u",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/x-ms-wma", "wma",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/x-ms-wax", "wax",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/x-pn-realaudio", "ra",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/x-pn-realaudio", "rm",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/x-pn-realaudio", "ram",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/x-realaudio", "ra",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/x-scpls", "pls",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/x-sd2", "sd2",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("audio/x-wav", "wav",R.drawable.audio_file);
            sMimeTypeMap.loadEntry("image/bmp", "bmp",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/gif", "gif",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/ico", "cur",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/ico", "ico",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/ief", "ief",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/jpeg", "jpeg",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/jpeg", "jpg",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/jpeg", "jpe",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/pcx", "pcx",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/png", "png",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/svg+xml", "svg",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/svg+xml", "svgz",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/tiff", "tiff",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/tiff", "tif",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/vnd.djvu", "djvu",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/vnd.djvu", "djv",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/vnd.wap.wbmp", "wbmp",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-cmu-raster", "ras",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-coreldraw", "cdr",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-coreldrawpattern", "pat",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-coreldrawtemplate", "cdt",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-corelphotopaint", "cpt",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-icon", "ico",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-jg", "art",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-jng", "jng",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-ms-bmp", "bmp",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-photoshop", "psd",R.drawable.ps_file);
            sMimeTypeMap.loadEntry("image/x-portable-anymap", "pnm",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-portable-bitmap", "pbm",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-portable-graymap", "pgm",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-portable-pixmap", "ppm",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-rgb", "rgb",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-xbitmap", "xbm",R.drawable.image_file);
            sMimeTypeMap.loadEntry("image/x-xpixmap", "xpm",R.drawable.image_file);
            ...
            sMimeTypeMap.loadEntry("text/plain", "txt",R.drawable.text_file);
            sMimeTypeMap.loadEntry("text/plain", "asc",R.drawable.text_file);
            sMimeTypeMap.loadEntry("text/plain", "text",R.drawable.text_file);
            sMimeTypeMap.loadEntry("text/plain", "diff",R.drawable.text_file);
            sMimeTypeMap.loadEntry("text/plain", "po",R.drawable.text_file);     // reserve "pot" for vnd.ms-powerpoint
            sMimeTypeMap.loadEntry("text/richtext", "rtx",R.drawable.text_file);
            sMimeTypeMap.loadEntry("text/rtf", "rtf");
            sMimeTypeMap.loadEntry("text/texmacs", "ts");
            sMimeTypeMap.loadEntry("text/text", "phps",R.drawable.text_file);
            sMimeTypeMap.loadEntry("text/tab-separated-values", "tsv");
            sMimeTypeMap.loadEntry("text/xml", "xml",R.drawable.xml_file);
            ...
            sMimeTypeMap.loadEntry("text/ebk2", "ebk2",R.drawable.ebk_file);
            sMimeTypeMap.loadEntry("text/ebk3", "ebk3",R.drawable.ebk_file);
            sMimeTypeMap.loadEntry("video/3gpp", "3gpp",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/3gpp", "3gp",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/3gpp", "3g2",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/dl", "dl",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/dv", "dif",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/dv", "dv",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/fli", "fli",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/m4v", "m4v",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/mpeg", "mpeg",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/mpeg", "mpg",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/mpeg", "mpe",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/mp4", "mp4",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/mpeg", "VOB",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/quicktime", "qt",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/quicktime", "mov",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/vnd.mpegurl", "mxu",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/x-la-asf", "lsf",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/x-la-asf", "lsx",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/x-mng", "mng",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/x-ms-asf", "asf",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/x-ms-asf", "asx",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/x-ms-wm", "wm",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/x-ms-wmv", "wmv",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/x-ms-wmx", "wmx",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/x-ms-wvx", "wvx",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/x-msvideo", "avi",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/x-sgi-movie", "movie",R.drawable.video_file);
            sMimeTypeMap.loadEntry("video/vnd.rn-realvideo", "rmvb",R.drawable.video_file);
    ...
    private HashMap<String, MimeTypeItem> mExtensionToMimeTypeMap;
}
